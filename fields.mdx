...
<Note>
  NDA-specific fields (purpose, confidential_information, remedies, etc.) and the NDA risk indicators are documented on the [NDA contract type page](/contract-types/nda).
</Note>
