...
| Contract Type | `contract_type` | Contract type name (e.g. "MSA", "NDA"). Resolved from the `type_id` foreign key on the contract row via `contract_types.name`. See [Contract Types](/contract-types) for the full mapping. |
