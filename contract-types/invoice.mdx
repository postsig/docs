...
<Tip>
  _Description placeholder — add a short note describing what an Invoice document is in PostSig._
</Tip>
...
| Field | Description |
| --- | --- |
| `products_licensed` | Products covered by this invoice |
...
This contract view includes the **Owner**, **Audit**, and **Lineage** tabs. Invoices do not show the **DORA** tab.
