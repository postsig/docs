...
NDAs include an automated risk assessment surfaced as `nda_risks`. Risk level is computed from 7 binary indicators: **High** (4\+ flags), **Medium** (1–3 flags), **Low** (0 flags). See [NDA Risk Indicators](/fields#nda-risk-indicators) for the full list.
...
This contract view includes the **Owner**, **Audit**, and **Lineage** tabs. NDAs do not show the **DORA** tab.
