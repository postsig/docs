...
**Server URL:** `https://app.postsig.com/api/cpm/mcp`
...
<Tabs>
  <Tab title="Claude">
    <Steps>
      ...
      <Step title="Add a custom connector">
        ...
        - **Name:** PostSig CPM
        - **URL:** `https://app.postsig.com/api/cpm/mcp`
      </Step>
      <Step title="Sign in">
  ...
  <Tab title="Claude Code">
    ...
    ```bash
    claude mcp add --transport http postsig-cpm https://app.postsig.com/api/cpm/mcp
    ```
