...
**Server URL:** `https://app.postsig.com/api/investor/mcp`
...
<Tabs>
  <Tab title="Claude">
    <Steps>
      ...
      <Step title="Add a custom connector">
        ...
        - **URL:** `https://app.postsig.com/api/investor/mcp`
      </Step>
      <Step title="Sign in">
  ...
  <Tab title="Claude Code">
    ...
    ```bash
    claude mcp add --transport http postsig-investor https://app.postsig.com/api/investor/mcp
    ```

    On first use a browser window opens for OAuth login.
  </Tab>
  <Tab title="Cursor">
    Open the command palette → **Open MCP Settings** → **Add custom MCP**. Then add the following to `mcp.json`:
    ...
    Reload Cursor and complete OAuth login when prompted.
  </Tab>
</Tabs>
